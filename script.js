const PLAYLIST1 = [
  ...
  { title: "Shape Of You ",       artist: "Ed Sheeran",                            duration: "3:53", color: "#e8c840", src: "audio/Ed_Sheeran_Shape_of_You_Lyrics_48KBPS.mp3" }, 
  { title: "Fairytale",           artist: "Alexander Rybak",                       duration: "3:02", color: "#264F37", src: "audio/Alexander_Rybak_-_Fairytale_Lyrics_Norway_Eurovision_Winner_2009_48kbps.mp3"}, 
  { title: "Criminal",            artist: "Britney Spears",                        duration: "3:43", color: "#ff6b35", src: "audio/Britney_Spears_-_Criminal_Lyrics_48kbps.mp3" }, 
  { title: "Alone, Pt. II",       artist: "Alan Walker & Ava Max",                 duration: "2:57", color: "#ff5e3a", src: "audio/Alan_Walker_Ava_Max_-_Alone_Pt__II_Lyrics_48kbps.mp3" }, 
